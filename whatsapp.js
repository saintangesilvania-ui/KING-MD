...
async function connectToWhatsApp(number) {
    ...
    try {
        ...
        // Si une SESSION_ID est configurée pour CE numéro précis (via SESSION_NUMBER), on
        // restaure les identifiants depuis la variable d'environnement — celle-ci survit
        // aux redémarrages de Render, contrairement au disque.
